...
document
  .querySelector("#card-pay-now-button")
  .addEventListener("click", detailsSubmit);
...
document.getElementById("total1").textContent = userDetails.total;
